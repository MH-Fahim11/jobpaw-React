          ...
          <div className="mobile-nav__content">
            ...
            <div className="mobile-nav__container">
              <ul className="main-menu__list">
                ...
                <li className="dropdown current">
                  <Link to="#" className={pageDrop ? "expanded" : ""}>
                    pages
                    <button
                      aria-label="dropdown toggler"
                      className={pageDrop ? "expanded" : ""}
                      onClick={() => setpageDrop(pageDrop ? false : true)}
                    >
                      <i className="fa fa-angle-down"></i>
                    </button>
                  </Link>
                ...
                <li className="dropdown">
                  <Link to="#" className={servicesDrop ? "expanded" : ""}>
                    ...
                    <button
                      ...
                      onClick={() =>
                        setservicesDrop(servicesDrop ? false : true)
                      }
                    >
                      <i className="fa fa-angle-down"></i>
                    </button>
                ...
                <li className="dropdown">
                  <Link to="#" className={projectsDrop ? "expanded" : ""}>
                    ...
                    <button
                      aria-label="dropdown toggler"
                      className={projectsDrop ? "expanded" : ""}
                      onClick={() =>
                        setprojectsDrop(projectsDrop ? false : true)
                      }
                    >
                ...
                <li className="dropdown">
                  <Link to="#" className={blogDrop ? "expanded" : ""}>
                    ...
                    <button
                      aria-label="dropdown toggler"
                      className={blogDrop ? "expanded" : ""}
                      onClick={() => setblogDrop(blogDrop ? false : true)}
                    >
                      <i className="fa fa-angle-down"></i>
                    </button>
                  </Link>
            ...
            <ul className="mobile-nav__contact list-unstyled">
              <li>
                ...
                <Link to="mailto:needhelp@hiredots.com">
                  needhelp@hiredots.com
                </Link>
              </li>
              <li>
