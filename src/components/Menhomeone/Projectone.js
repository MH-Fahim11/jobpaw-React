...
export const tenderItems = [
  {
    ...
    description: "Inviting proposals for the redesign of our company website. The current website lacks modern design elements and user-friendly navigation. We are seeking proposals from experienced web designers and developers to revamp the website and create a more visually appealing and intuitive user experience. The redesign should reflect our brand identity and incorporate responsive design principles to ensure compatibility across various devices. Deadline for submission of proposals is May 1, 2024.",
            ...
            <div key={index} className="col-md-6 col-lg-4">
              ...
              >
                ...
                <div className="service-one-card__content">
                  ...
                  <p style={{marginBottom:"-20px", marginTop:"10px"}}>Company:  {service.organization}</p>
                </div>
                <Link to={`/tenders/${createSlug(service.title)}`} className="service-one-card__link">
                  Apply now
